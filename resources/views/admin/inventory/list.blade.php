                    ...
                    <div class="card-body">
                        <table id="inventoryGroup" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{$inventoryitem->group->title}}</td>
                                    <td>{{$inventoryitem->label}}</td>
                                    <td>{{$inventoryitem->quantity}}</td>
                                    @php
                                    $inventoryItemProperties = $inventoryitem->itemProperties[0]->properties;
                                    @endphp
                                    <td>
                                                        ...
                                                        <div class="card card-primary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="hidden" name="group_id" value="{{$inventoryitem->group->id}}">
